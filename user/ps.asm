...
int main (int argc, char **argv) {
  ...
  16:	74fd                	lui	s1,0xfffff
  18:	7c048793          	addi	a5,s1,1984 # fffffffffffff7c0 <__global_pointer$+0xffffffffffffe707>
  1c:	00f40533          	add	a0,s0,a5
  20:	00000097          	auipc	ra,0x0
  24:	386080e7          	jalr	902(ra) # 3a6 <getprocs>
  28:	8aaa                	mv	s5,a0
	printf("%d", nprocs);
  2a:	85aa                	mv	a1,a0
  ...
  38:	654080e7          	jalr	1620(ra) # 688 <printf>
	...
	if (nprocs < 0){
  3c:	7d048793          	addi	a5,s1,2000
  40:	00f404b3          	add	s1,s0,a5
  44:	fd040a13          	addi	s4,s0,-48
		exit(-1);
	}

  	for(p = uproc; p < &uproc[NPROC]; p++){
    	printf("%d %d %s %s", p->pid, p->size, p->state, p->name);
  48:	00000997          	auipc	s3,0x0
  4c:	7e898993          	addi	s3,s3,2024 # 830 <malloc+0xf0>
    	printf("\n");
  50:	00000917          	auipc	s2,0x0
  54:	7f090913          	addi	s2,s2,2032 # 840 <malloc+0x100>
	if (nprocs < 0){
  58:	020acc63          	bltz	s5,90 <main+0x90>
    	printf("%d %d %s %s", p->pid, p->size, p->state, p->name);
  5c:	8726                	mv	a4,s1
  5e:	ff44a683          	lw	a3,-12(s1)
  62:	ff84a603          	lw	a2,-8(s1)
  66:	ff04a583          	lw	a1,-16(s1)
  6a:	854e                	mv	a0,s3
  6c:	00000097          	auipc	ra,0x0
  70:	61c080e7          	jalr	1564(ra) # 688 <printf>
    	printf("\n");
  74:	854a                	mv	a0,s2
  76:	00000097          	auipc	ra,0x0
  7a:	612080e7          	jalr	1554(ra) # 688 <printf>
  	for(p = uproc; p < &uproc[NPROC]; p++){
  7e:	02048493          	addi	s1,s1,32
  82:	fd449de3          	bne	s1,s4,5c <main+0x5c>
  	}
  ...
  8c:	27e080e7          	jalr	638(ra) # 306 <exit>
		exit(-1);
  90:	557d                	li	a0,-1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	4b650513          	addi	a0,a0,1206 # 8a8 <digits>
 3fa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b6:	39ec8c93          	addi	s9,s9,926 # 850 <malloc+0x110>
 ...
 4c4:	3e8b8b93          	addi	s7,s7,1000 # 8a8 <digits>
 ...
 5ea:	26298993          	addi	s3,s3,610 # 848 <malloc+0x108>
        while(*s != 0){
 5ee:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6cc:	1f87b783          	ld	a5,504(a5) # 8c0 <freep>
 ...
 6f4:	00e6ea63          	bltu	a3,a4,708 <free+0x4a>
{
 ...
 736:	18f73723          	sd	a5,398(a4) # 8c0 <freep>
}
 73a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 768:	15c53503          	ld	a0,348(a0) # 8c0 <freep>
 ...
 790:	13490913          	addi	s2,s2,308 # 8c0 <freep>
  if(p == (char*)-1)
 794:	5afd                	li	s5,-1
 796:	a895                	j	80a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 798:	00000797          	auipc	a5,0x0
 79c:	13078793          	addi	a5,a5,304 # 8c8 <base>
 ...
 7cc:	0ea73c23          	sd	a0,248(a4) # 8c0 <freep>
      return (void*)(p + 1);
 ...
 81a:	b78080e7          	jalr	-1160(ra) # 38e <sbrk>
  if(p == (char*)-1)
